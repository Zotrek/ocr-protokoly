...
- **POC:** [`index.html`](index.html), [`protocol_parse.mjs`](protocol_parse.mjs), [`roi_ocr.mjs`](roi_ocr.mjs), [`export_xlsx.mjs`](export_xlsx.mjs) — Excel dzienny, `done` / `problematyczne` (Chrome + folder z zapisem)
